...
class Controls_Manager {
	...
	private static function _get_available_tabs_controls() {
		if ( ! self::$_available_tabs_controls ) {
			self::$_available_tabs_controls = [
				self::TAB_CONTENT => __( 'Content', 'kitbuilder' ),
				self::TAB_STYLE => __( 'Style', 'kitbuilder' ),
				self::TAB_ADVANCED => __( 'Advanced', 'kitbuilder' ),
				self::TAB_RESPONSIVE => __( 'Responsive', 'kitbuilder' ),
				self::TAB_LAYOUT => __( 'Layout', 'kitbuilder' ),
				self::TAB_SETTINGS => __( 'Settings', 'kitbuilder' ),
			];

			self::$_available_tabs_controls = apply_filters( 'kitbuilder/controls/get_available_tabs_controls', self::$_available_tabs_controls );
		}
	...
	public function register_controls() {
		...
		foreach ( $available_controls as $control_id ) {
			...
			$control_filename = KITBUILDER_PATH . "includes/controls/{$control_filename}.php";
		...
		// Group Controls
		require( KITBUILDER_PATH . 'includes/controls/groups/background.php' );
		require( KITBUILDER_PATH . 'includes/controls/groups/border.php' );
		require( KITBUILDER_PATH . 'includes/controls/groups/typography.php' );
		require( KITBUILDER_PATH . 'includes/controls/groups/image-size.php' );
		require( KITBUILDER_PATH . 'includes/controls/groups/box-shadow.php' );
		...
		do_action( 'kitbuilder/controls/controls_registered', $this );
	}
	 ...
	 * @param $control_id
	 *
	 * @return bool|\Kitbuilder\Control_Base
	 */
	...
	private function require_files() {
		...
		require( KITBUILDER_PATH . 'includes/controls/base.php' );
		require( KITBUILDER_PATH . 'includes/controls/base-multiple.php' );
		require( KITBUILDER_PATH . 'includes/controls/base-units.php' );

		// Group Controls
		require( KITBUILDER_PATH . 'includes/interfaces/group-control.php' );
		require( KITBUILDER_PATH . 'includes/controls/groups/base.php' );
	}
