...
class Images_Manager {
	...
	public function get_details( $id, $size, $is_first_time ) {
		if ( ! class_exists( 'Group_Control_Image_Size' ) ) {
			require_once KITBUILDER_PATH . '/includes/controls/groups/image-size.php';
		}
	...
	public function __construct() {
		add_action( 'wp_ajax_kitbuilder_get_image_details', [ $this, 'get_image_details' ] );
		add_action( 'wp_ajax_kitbuilder_get_images_details', [ $this, 'get_images_details' ] );
	}
}
