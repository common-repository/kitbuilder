		...
		<div class="kitbuilder-control-field">
			...
			<div class="kitbuilder-control-input-wrapper">
				<div class="kitbuilder-control-media">
					<div class="kitbuilder-control-media-upload-button">
						<i class="fa fa-plus-circle"></i>
					</div>
					<div class="kitbuilder-control-media-image-area">
						<div class="kitbuilder-control-media-image" style="background-image: url({{ data.controlValue.url }});"></div>
						<div class="kitbuilder-control-media-delete"><?php _e( 'Delete', 'kitbuilder' ); ?></div>
					</div>
				</div>
			</div>
			<# if ( data.description ) { #>
