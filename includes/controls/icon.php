	...
	public function content_template() {
		...
		<div class="kitbuilder-control-field">
			...
			<div class="kitbuilder-control-input-wrapper">
				<select class="kitbuilder-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php _e( 'Select Icon', 'kitbuilder' ); ?>">
					<option value=""><?php _e( 'Select Icon', 'kitbuilder' ); ?></option>
