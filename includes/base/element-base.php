...
abstract class Element_Base extends Controls_Stack {
	...
	public function print_template() {
		...
		$content_template = Utils::apply_filters_deprecated( 'kitbuilder/elements/print_template', [ $content_template, $this ], '1.0.10', 'kitbuilder/element/print_template' );

		$content_template = apply_filters( 'kitbuilder/element/print_template', $content_template, $this );

		if ( empty( $content_template ) ) {
			return;
		}
		?>
		<script type="text/html" id="tmpl-kitbuilder-<?php echo $this->get_type(); ?>-<?php echo esc_attr( $this->get_name() ); ?>-content">
	...
	public function print_element() {
		...
		do_action( 'kitbuilder/frontend/' . static::get_type() . '/before_render', $this );
		...
		do_action( 'kitbuilder/frontend/' . static::get_type() . '/after_render', $this );
	}
	...
	public function get_unique_selector() {
		return '.kitbuilder-element-' . $this->get_id();
	}
	...
	protected function _render_settings() {
		...
		<div class="kitbuilder-element-overlay">
			<div class="kitbuilder-editor-element-settings kitbuilder-editor-<?php echo esc_attr( $this->get_type() ); ?>-settings kitbuilder-editor-<?php echo esc_attr( $this->get_name() ); ?>-settings">
				<ul class="kitbuilder-editor-element-settings-list">
					<li class="kitbuilder-editor-element-setting kitbuilder-editor-element-add">
						<a href="#" title="<?php _e( 'Add Widget', 'kitbuilder' ); ?>">
							<span class="kitbuilder-screen-only"><?php _e( 'Add', 'kitbuilder' ); ?></span>
							<i class="fa fa-plus"></i>
						</a>
					</li>
					<?php /* Temp removing for better UI
					<li class="kitbuilder-editor-element-setting kitbuilder-editor-element-edit">
						<a href="#" title="<?php _e( 'Edit Widget', 'kitbuilder' ); ?>">
							<span class="kitbuilder-screen-only"><?php _e( 'Edit', 'kitbuilder' ); ?></span>
							<i class="fa fa-pencil"></i>
						</a>
					</li>
					*/ ?>
					<li class="kitbuilder-editor-element-setting kitbuilder-editor-element-duplicate">
						<a href="#" title="<?php _e( 'Duplicate Widget', 'kitbuilder' ); ?>">
							<span class="kitbuilder-screen-only"><?php _e( 'Duplicate', 'kitbuilder' ); ?></span>
							<i class="fa fa-files-o"></i>
						</a>
					</li>
					<li class="kitbuilder-editor-element-setting kitbuilder-editor-element-remove">
						<a href="#" title="<?php _e( 'Remove Widget', 'kitbuilder' ); ?>">
							<span class="kitbuilder-screen-only"><?php _e( 'Remove', 'kitbuilder' ); ?></span>
	...
	private function _get_child_type( $element_data ) {
		...
		return apply_filters( 'kitbuilder/element/get_child_type', $child_type, $element_data, $this );
	}
