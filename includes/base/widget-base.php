...
abstract class Widget_Base extends Element_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		if ( $is_type_instance ) {
			...
			do_action( 'kitbuilder/widget/' . $this->get_name() . '/skins_init', $this );
		}
	}
	...
	private function _register_skin_control() {
		...
		if ( ! empty( $skins ) ) {
			...
			if ( $this->_has_template_content ) {
				$skin_options[''] = __( 'Default', 'kitbuilder' );
			}
	...
	final public function print_template() {
		...
		$content_template = apply_filters( 'kitbuilder/widget/print_template', $content_template,  $this );

		if ( empty( $content_template ) ) {
			return;
		}
		?>
		<script type="text/html" id="tmpl-kitbuilder-<?php echo static::get_type(); ?>-<?php echo esc_attr( $this->get_name() ); ?>-content">
			<?php $this->_render_settings(); ?>
			<div class="kitbuilder-widget-container">
	...
	protected function _render_settings() {
		?>
		<div class="kitbuilder-editor-element-settings kitbuilder-editor-<?php echo esc_attr( static::get_type() ); ?>-settings kitbuilder-editor-<?php echo esc_attr( $this->get_name() ); ?>-settings">
	...
	public function render_content() {
		...
		<div class="kitbuilder-widget-container">
			...
			echo apply_filters( 'kitbuilder/widget/render_content', ob_get_clean(), $this );
			?>
		</div>
		<?php
	}
	...
	protected function _add_render_attributes() {
		...
		$this->add_render_attribute( '_wrapper', 'class', [
			'kitbuilder-widget',
			'kitbuilder-widget-' . $this->get_name(),
		] );
