...
abstract class Controls_Stack {
	...
	public function start_controls_section( $section_id, array $args ) {
		do_action( 'kitbuilder/element/before_section_start', $this, $section_id, $args );
		do_action( 'kitbuilder/element/' . $this->get_name() . '/' . $section_id . '/before_section_start', $this, $args );
		...
		if ( null !== $this->_current_section ) {
			wp_die( sprintf( 'Kitbuilder: You can\'t start a section before the end of the previous section: `%s`', $this->_current_section['section'] ) );
		}

		$this->_current_section = $this->get_section_args( $section_id );

		do_action( 'kitbuilder/element/after_section_start', $this, $section_id, $args );
		do_action( 'kitbuilder/element/' . $this->get_name() . '/' . $section_id . '/after_section_start', $this, $args );
	}
	...
	public function end_controls_section() {
		...
		do_action( 'kitbuilder/element/before_section_end', $this, $section_id, $args );
		do_action( 'kitbuilder/element/' . $this->get_name() . '/' . $section_id . '/before_section_end', $this, $args );

		$this->_current_section = null;

		do_action( 'kitbuilder/element/after_section_end', $this, $section_id, $args );
		do_action( 'kitbuilder/element/' . $this->get_name() . '/' . $section_id . '/after_section_end', $this, $args );
	}

	public function start_controls_tabs( $tabs_id ) {
		if ( null !== $this->_current_tab ) {
			wp_die( sprintf( 'Kitbuilder: You can\'t start tabs before the end of the previous tabs: `%s`', $this->_current_tab['tabs_wrapper'] ) );
		}
	...
	public function start_controls_tab( $tab_id, $args ) {
		if ( ! empty( $this->_current_tab['inner_tab'] ) ) {
			wp_die( sprintf( 'Kitbuilder: You can\'t start a tab before the end of the previous tab: `%s`', $this->_current_tab['inner_tab'] ) );
		}
