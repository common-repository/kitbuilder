...
class Utils {
	...
	public static function get_edit_link( $post_id = 0 ) {
		return apply_filters( 'kitbuilder/utils/get_edit_link', add_query_arg( 'kitbuilder', '', get_permalink( $post_id ) ), $post_id );
	}

	public static function is_post_type_support( $post_id = 0 ) {
		$post_type = get_post_type( $post_id );
		$is_supported = post_type_supports( $post_type, 'kitbuilder' );

		return apply_filters( 'kitbuilder/utils/is_post_type_support', $is_supported, $post_id, $post_type );
	}

	public static function get_placeholder_image_src() {
		return apply_filters( 'kitbuilder/utils/get_placeholder_image_src', KITBUILDER_ASSETS_URL . 'images/placeholder.png' );
	}
