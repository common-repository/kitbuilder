...
class Widget_Icon extends Widget_Base {
	...
	public function get_title() {
		return __( 'Icon', 'kitbuilder' );
	}

	public function get_icon() {
		return 'kb kb-favorite';
	}
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .kitbuilder-icon-wrapper' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'icon_padding',
			[
				'label' => __( 'Icon Padding', 'kitbuilder' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'kitbuilder-icon-wrapper' );

		$this->add_render_attribute( 'icon-wrapper', 'class', 'kitbuilder-icon' );

		if ( ! empty( $settings['hover_animation'] ) ) {
			$this->add_render_attribute( 'icon-wrapper', 'class', 'kitbuilder-animation-' . $settings['hover_animation'] );
		}
	...
	protected function _content_template() {
		...
		<#
				...
				iconTag = link ? 'a' : 'div';
        #>
		<div class="kitbuilder-icon-wrapper">
			<{{{ iconTag }}} class="kitbuilder-icon kitbuilder-animation-{{ settings.hover_animation }}" {{{ link }}}>
